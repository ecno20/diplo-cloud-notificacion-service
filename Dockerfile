...
COPY --from=build /usr/src/app/target/diplo-cloud-notificacion-service.jar /app/diplo-cloud-notificacion-service.jar
#Expone el puerto en el que la aplicación se ejecutará
EXPOSE 8080
#Comando para ejecutar la aplicación al iniciar el contenedor
CMD ["java", "-jar", "/app/diplo-cloud-notificacion-service.jar"]